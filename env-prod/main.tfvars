...
apps = {
  ...
  catalogue = {
    ...
    extra_param_access = ["arn:aws:ssm:us-east-1:968585591903:parameter/roboshop.prod.docdb.*"]
  ...
  shipping = {
    ...
    extra_param_access = ["arn:aws:ssm:us-east-1:968585591903:parameter/roboshop.prod.mysql.*"]
